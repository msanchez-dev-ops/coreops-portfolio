...
- **2,263 automated backend tests**, verified through test discovery.
...
- **671 commits** across roughly three months of active development.
- **~35,900 lines** of backend application code, excluding migrations and tests.
- **~35,090 lines** of backend test code.
- **~20,491 lines** of frontend TypeScript/TSX.
- **247 database migrations.**
- **2,263 automated backend tests.**
